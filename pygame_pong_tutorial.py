...
pong_sound = pygame.mixer.Sound("ping_pong_8bit_plop.ogg")
score_sound = pygame.mixer.Sound("ping_pong_8bit_beeep.ogg")
...
while True:
    ...
    screen.blit(player_text, (410, 470))
    opponent_text = game_font.render(f"{opponent_score}", False, light_grey)
    screen.blit(opponent_text, (470, 470))
